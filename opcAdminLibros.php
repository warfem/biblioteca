...
if(isset($_POST['addLibro'])){//Formulario para añadir libros en la BD
    ...
    echo" <input type='text' name='sinopsis' style='width: 400px; height: 200px; margin-left: 10px;'><br>";
    ...
    echo"<input type='text' name='idUser' required><br>";
    echo"<label>Nombre:</label>";
    echo"<input type='text' name='nombreUser' required><br>";
